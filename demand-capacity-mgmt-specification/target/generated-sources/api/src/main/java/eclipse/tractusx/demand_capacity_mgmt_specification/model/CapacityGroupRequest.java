...
public class CapacityGroupRequest {
  ...
  public CapacityGroupRequest capacities(List<CapacityResponse> capacities) {
    this.capacities = capacities;
    return this;
  }

  public CapacityGroupRequest addCapacitiesItem(CapacityResponse capacitiesItem) {
  ...
  */
  ...
  public CapacityGroupRequest supplierLocations(List<CompanyDto> supplierLocations) {
    this.supplierLocations = supplierLocations;
    return this;
  }

  public CapacityGroupRequest addSupplierLocationsItem(CompanyDto supplierLocationsItem) {
  ...
  */
  ...
  public CapacityGroupRequest customer(CompanyDto customer) {
  ...
  */
  ...
  public CapacityGroupRequest supplier(CompanyDto supplier) {
  ...
  */
  ...
  public CapacityGroupRequest capacityGroupId(String capacityGroupId) {
  ...
  */
  ...
  public CapacityGroupRequest linkedDemandSeries(List<LinkedDemandSeriesResponse> linkedDemandSeries) {
    this.linkedDemandSeries = linkedDemandSeries;
    return this;
  }

  public CapacityGroupRequest addLinkedDemandSeriesItem(LinkedDemandSeriesResponse linkedDemandSeriesItem) {
  ...
  */
  ...
  public CapacityGroupRequest unitOfMeasure(UnitMeasure unitOfMeasure) {
  ...
  */
  ...
  public CapacityGroupRequest changeAt(String changeAt) {
  ...
  */
  ...
  public CapacityGroupRequest name(String name) {
    this.name = name;
    return this;
  }
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    CapacityGroupRequest capacityGroupRequest = (CapacityGroupRequest) o;
    return Objects.equals(this.capacities, capacityGroupRequest.capacities) &&
        Objects.equals(this.supplierLocations, capacityGroupRequest.supplierLocations) &&
        Objects.equals(this.customer, capacityGroupRequest.customer) &&
        Objects.equals(this.supplier, capacityGroupRequest.supplier) &&
        Objects.equals(this.capacityGroupId, capacityGroupRequest.capacityGroupId) &&
        Objects.equals(this.linkedDemandSeries, capacityGroupRequest.linkedDemandSeries) &&
        Objects.equals(this.unitOfMeasure, capacityGroupRequest.unitOfMeasure) &&
        Objects.equals(this.changeAt, capacityGroupRequest.changeAt) &&
        Objects.equals(this.name, capacityGroupRequest.name);
  }
  ...
  public String toString() {
    ...
    sb.append("class CapacityGroupRequest {\n");
